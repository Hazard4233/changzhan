<template>
    <div class="h-full flex flex-col">
        <div class="absolute top-10 flex flex-row items-center" style="left:29.65284vw;top:4.9662487vw;">
            ...
            <router-link to="/page5/part2">
                <div class="flex flex-row items-center cursor-pointer" style="margin-left:2.89296vw;">
                    ...
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                        style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(187, 124, 31)); font-size: 0.867888vw;">运维人员管理</div>
                </div>
            </router-link>
        ...
        <div class="page5_part2 mx-auto" style="padding-top:32px;padding-left:43px;padding-right: 43px;font-size:0.7714561vw;">
            <div class="tb_option_list w-full flex flex-row items-center">
                ...
                <RecBlueBtn class="ml-auto" text="地图模式"/>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <td class="text-white text-center" style="padding:0.83333vw;">服务号</td>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in tb_data" :key="index + 'id'" class="text-center" :class="{'hidden': index > num_per_page - 1}" style="height:3.645833vw;">
                            ...
                            <td class=" text-r205g234b255" style="width:12%;">{{item.account}}</td>
                            <td class=" text-r205g234b255" style="width:12%">{{item.name}}</td>
                            <td class=" text-r205g234b255" style="width:12%">{{item.department}}</td>
                            <td class=" text-r205g234b255" style="width:12%">{{item.service_num}}</td>
                            <td class=" text-r205g234b255" style="width:12%">{{item.phone}}</td>
                            <td class=" text-r205g234b255" style="width:12%">
...
export default {
    ...
    mounted: function() {
        ...
        for (let index = 0; index < 50; index++) {
            ...
            obj_var.service_num = Math.round(Math.random() * 1000000)
...
.page5_part2 {
    width: 85.364583vw;
    height: 25.989583vw;
    background-image: url('../assets/img/page5_part2_bg.png');
