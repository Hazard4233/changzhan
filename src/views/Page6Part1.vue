        ...
        <div class="absolute top-10 flex flex-row items-center" style="left:29.65284vw;top:4.9662487vw;">
            <router-link to="/page6/part1">
                <div class="flex flex-row items-center cursor-pointer">
                    ...
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                        style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(187, 124, 31)); font-size: 0.867888vw;">实时报警</div>
                </div>
            </router-link>
            <router-link to="/page6/part2">
                <div class="flex flex-row items-center cursor-pointer" style="margin-left:2.89296vw;">
                    ...
                    <div class="text-r205g234b255 px-2 ml-1 flex flex-row items-center justify-center" 
                        style="height: 1.63934vw; background-image: linear-gradient(to bottom, rgb(0, 0, 0), rgb(25, 71, 107)); font-size: 0.867888vw;">历史报警</div>
                </div>
            </router-link>
        </div>
        
        <div class="page6_part1 mx-auto" style="padding-top:32px;padding-left:43px;padding-right: 43px;font-size:0.7714561vw;">

            <div class="flex flex-row items-center">
                <div class=" text-r205g234b255">设备编号</div>
                ...
                <div class=" text-r205g234b255" style="margin-left: 2.0833vw;">报警类型</div>
                <SelectInput :option_list="['请选择1', '请选择2']" style="margin-left:0.46875vw;"/>
                <div class=" text-r205g234b255" style="margin-left: 2.0833vw;">报警时间段</div>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <td class="text-white text-center" style="padding:0.83333vw;">报警原因</td>
                            <td class="text-white text-center" style="padding:0.83333vw;">报警时间</td>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in tb_data" :key="index + 'id'" class="text-center" :class="{'hidden': index > num_per_page - 1}" style="height:3.645833vw;">
                            ...
                            <td class=" text-r205g234b255" style="width:10%">{{item.region}}</td>
                            <td class=" text-r205g234b255" style="width:15%">{{item.type}}</td>
                            <td class=" text-r205g234b255" style="width:15%">{{item.equip_num}}</td>
                            <td class=" text-r205g234b255" style="width:15%">{{item.alaram_cause}}</td>
                            <td class=" text-r205g234b255" style="width:20%">{{item.alaram_time}}</td>
                            <td class="" style="">
                                <div class="flex flex-row items-center cursor-pointer">
                                    <div class="text-red-500 mx-auto underline action-btn">确认</div>
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
export default {
    ...
    mounted: function() {
        ...
        for (let index = 0; index < 50; index++) {
            ...
            obj_var.alaram_cause = "汽油车占位"
            obj_var.alaram_time = "2021-05-11 12:11:11"
...
.page6_part1 {
    width: 79.02603vw;
    height: 33.31726vw;
    background-image: url('../assets/img/page6_part1_bg.png');
    background-size: 100% 100%;
    background-repeat: no-repeat;
}
.tb_option_list .btn_type_2 {
    width: 7.5vw;
    height: 2.0833vw;
    background-image: url('../assets/img/page5_part1_btn_bg_2.png');
    background-size: 100% 100%;
    background-repeat: no-repeat;
    display: flex;
    flex-direction: row;
...
.btn_type_3 {
    width: 7.9166vw;
    height: 2.65625vw;
    background-image: url('../assets/img/page5_part2_btn_bg_2.png');
    background-size: 100% 100%;
    background-repeat: no-repeat;
    display: flex;
    flex-direction: row;
